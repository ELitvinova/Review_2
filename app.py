...
if token != 'TELEGRAM_TOKEN':
    ...
    text_messages = {
        ...
        'help':
            ...
            'If you want a picture of a special breed, '
            'you can use command /breed'
    ...
    def get_by_sub_breed(message):
        ...
        try:
            ...
            bot.send_message(message.chat.id,
                             'Ooops, you did something wrong...')
            return

        # getting response from the dataset
        response = requests.\
            get('https://dog.ceo/api/breed/{}-{}/images/random'.
    ...
    def select_sub_breed(message, breed):
        """
        This function provides a keyboard to help user
        to enter the sub-breed name. Also it redirects his answer
        to function, sending image of this sub-breed.
        """
        ...
        # setting function get_by_sub_breed as a handler for user's response
